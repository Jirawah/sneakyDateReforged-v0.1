...
# ============================================
# Build & Run - SneakyDateReforged (backend)
# ============================================
...
#     @{ Name = "ms-friend";       Path = "..\sdr-backend\ms-friend";       Image = "jirawah/ms-friend:latest" },
#     @{ Name = "ms-invitation";   Path = "..\sdr-backend\ms-invitation";   Image = "jirawah/ms-invitation:latest" },
#     @{ Name = "ms-notif";        Path = "..\sdr-backend\ms-notif";        Image = "jirawah/ms-notif:latest" }  # ← ajouté
# )
#
# $basePath = Split-Path -Parent $MyInvocation.MyCommand.Path
# Set-Location $basePath
...
#
# Write-Host "=== Lancement de docker-compose up -d ===" -ForegroundColor Cyan
# # Utilise docker-compose (legacy) si c’est ce que tu as, sinon remplace par `docker compose`
# docker-compose up -d
# if ($LASTEXITCODE -ne 0) {
#     Write-Host "Échec du lancement de docker-compose. Vérifiez votre configuration." -ForegroundColor Red
#     exit 1
...
# }
#
# # *** AJOUT MINIMAL : build spécifique du frontend (ms-webapp) ***
...
#
# Write-Host "=== Lancement de docker-compose up -d ===" -ForegroundColor Cyan
# # Remplace par `docker compose up -d` si tu utilises la v2
# docker-compose up -d
# if ($LASTEXITCODE -ne 0) {
#     Write-Host "Échec du lancement de docker-compose. Vérifiez votre configuration." -ForegroundColor Red
#     exit 1
